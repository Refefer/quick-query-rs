...
impl InternalAgent for WriterAgent {
    ...
    fn tool_names(&self) -> &[&str] {
        &["read_file", "write_file", "replace_in_file", "insert_in_file", "delete_lines", "replace_lines", "copy_file", "create_directory", "find_files", "search_files", "bash", "mount_external", "update_my_task"]
    }
